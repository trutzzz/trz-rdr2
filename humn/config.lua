...
["MSG"] = "Anda Mengkonsumsi ", -- Message to display when consumed
...
["Tick"] = 40000, -- 1000 = 1 second; 20000 = 20 seconds; 3600 = 3,5 seconds
...
Config.ItemsToUse = {
    ...
    --
    {
        ...
        ["DisplayName"] = "Bread", -- Name on screen (label from DB)
