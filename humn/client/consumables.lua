...
RegisterNetEvent("humn:useItem")
AddEventHandler("humn:useItem", function(index)
...
RegisterNetEvent("humn:consume")
AddEventHandler("humn:consume", function(hunger, thirst, innercorestamina, innercorestaminagold, outercorestaminagold, innercorehealth, innercorehealthgold, outercorehealthgold)
